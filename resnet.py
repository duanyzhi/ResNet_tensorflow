...
def Residual_Block(img, pre_img, weight, biases, offset, scale, strides=1):
    ...
    if input_shape != output_shape:
        ...
        ResNet().parameters += [weight_pre, biases_pre]
    else:
    ...
    def __call__(self, img, scope):
        ...
        with tf.variable_scope(scope, reuse=self.reuse) as scope_name:
            ...
            with tf.variable_scope('conv1'):
                ...
                conv1_ReLu = conv(self.img, weight_1, biases_1, offset_1, scale_1, strides=2)
                conv1 = max_pool(conv1_ReLu, k_size=(2, 2), stride=(2, 2))   # out [56, 56, 64]
                self.parameters += [weight_1, biases_1, offset_1, scale_1]
            # conv2
            with tf.variable_scope('conv2'):
                with tf.variable_scope('conv2_1'):
                    with tf.variable_scope('conv2_1_1'):
                        ...
                        self.parameters += [weight2_1_1, biases2_1_1, offset2_1_1, scale2_1_1]
                    with tf.variable_scope('conv2_1_2'):
                        ...
                        self.parameters += [weight2_1_2, biases2_1_2, offset2_1_2, scale2_1_2]
                    with tf.variable_scope('conv2_1_3'):
                        ...
                        self.parameters += [weight2_1_3, biases2_1_3, offset2_1_3, scale2_1_3]
                with tf.variable_scope('conv2_2'):
                    with tf.variable_scope('conv2_2_1'):
                        ...
                        self.parameters += [weight2_2_1, biases2_2_1, offset2_2_1, scale2_2_1]
                    with tf.variable_scope('conv2_2_2'):
                        ...
                        self.parameters += [weight2_2_2, biases2_2_2, offset2_2_2, scale2_2_2]
                    with tf.variable_scope('conv2_2_3'):
                        ...
                        self.parameters += [weight2_2_3, biases2_2_3, offset2_2_3, scale2_2_3]
                with tf.variable_scope('conv2_3'):
                    with tf.variable_scope('conv2_3_1'):
                        ...
                        self.parameters += [weight2_3_1, biases2_3_1, offset2_3_1, scale2_3_1]
                    with tf.variable_scope('conv2_3_2'):
                        ...
                        self.parameters += [weight2_3_2, biases2_3_2, offset2_3_2, scale2_3_2]
                    with tf.variable_scope('conv2_3_3'):
                        ...
                        self.parameters += [weight2_3_3, biases2_3_3, offset2_3_3, scale2_3_3]
            ...
            with tf.variable_scope('conv3'):
                with tf.variable_scope('conv3_1'):
                    with tf.variable_scope('conv3_1_1'):
                        ...
                        self.parameters += [weight3_1_1, biases3_1_1, offset3_1_1, scale3_1_1]
                    with tf.variable_scope('conv3_1_2'):
                        ...
                        self.parameters += [weight3_1_2, biases3_1_2, offset3_1_2, scale3_1_2]
                    with tf.variable_scope('conv3_1_3'):
                        ...
                        self.parameters += [weight3_1_3, biases3_1_3, offset3_1_3, scale3_1_3]
                with tf.variable_scope('conv3_2'):
                    with tf.variable_scope('conv3_2_1'):
                        ...
                        self.parameters += [weight3_2_1, biases3_2_1, offset3_2_1, scale3_2_1]
                    with tf.variable_scope('conv3_2_2'):
                        ...
                        self.parameters += [weight3_2_2, biases3_2_2, offset3_2_2, scale3_2_2]
                    with tf.variable_scope('conv3_2_3'):
                        ...
                        self.parameters += [weight3_2_3, biases3_2_3, offset3_2_3, scale3_2_3]
                with tf.variable_scope('conv3_3'):
                    with tf.variable_scope('conv3_3_1'):
                        ...
                        self.parameters += [weight3_3_1, biases3_3_1, offset3_3_1, scale3_3_1]
                    with tf.variable_scope('conv3_3_2'):
                        ...
                        self.parameters += [weight3_3_2, biases3_3_2, offset3_3_2, scale3_3_2]
                    with tf.variable_scope('conv3_3_3'):
                        ...
                        self.parameters += [weight3_3_3, biases3_3_3, offset3_3_3, scale3_3_3]
                with tf.variable_scope('conv3_4'):
                    with tf.variable_scope('conv3_4_1'):
                        ...
                        conv3_4_1_ReLu = conv(conv3_3, weight3_4_1, biases3_4_1, offset3_4_1, scale3_4_1,
                                              strides=1)
                        self.parameters += [weight3_4_1, biases3_4_1, offset3_4_1, scale3_4_1]
                    with tf.variable_scope('conv3_4_2'):
                        ...
                        conv3_4_2_ReLu = conv(conv3_4_1_ReLu, weight3_4_2, biases3_4_2, offset3_4_2, scale3_4_2,
                                              strides=1)
                        self.parameters += [weight3_4_2, biases3_4_2, offset3_4_2, scale3_4_2]
                    with tf.variable_scope('conv3_4_3'):
                        ...
                        self.parameters += [weight3_4_3, biases3_4_3, offset3_4_3, scale3_4_3]
                    ...
                    with tf.variable_scope('conv4_' + str(kk)):
                        with tf.variable_scope('conv4_1'):
                            ...
                            conv4_1_ReLu = conv(in_img, weight4_1, biases4_1, offset4_1, scale4_1,
                                                  strides=1)
                            self.parameters += [weight4_1, biases4_1, offset4_1, scale4_1]
                        with tf.variable_scope('conv4_2'):
                            ...
                            conv4_2_ReLu = conv(conv4_1_ReLu, weight4_2, biases4_2, offset4_2, scale4_2,
                                                  strides=1)
                            self.parameters += [weight4_2, biases4_2, offset4_2, scale4_2]
                        with tf.variable_scope('conv4_3'):
                            ...
                            conv3_4 = Residual_Block(conv4_2_ReLu, in_img, weight4_3, biases4_3, offset4_3,
                                                     scale4_3, strides=1)
                            self.parameters += [weight4_3, biases4_3, offset4_3, scale4_3]
                    in_img = conv3_4
            ...
            with tf.variable_scope('conv5'):
                with tf.variable_scope('conv5_1'):
                    with tf.variable_scope('conv5_1_1'):
                        ...
                        self.parameters += [weight5_1_1, biases5_1_1, offset5_1_1, scale5_1_1]
                    with tf.variable_scope('conv5_1_2'):
                        ...
                        conv5_1_2_ReLu = conv(conv5_1_1_ReLu, weight5_1_2, biases5_1_2, offset5_1_2, scale5_1_2,
                                              strides=1)
                        self.parameters += [weight5_1_2, biases5_1_2, offset5_1_2, scale5_1_2]
                    with tf.variable_scope('conv5_1_3'):
                        ...
                        self.parameters += [weight5_1_3, biases5_1_3, offset5_1_3, scale5_1_3]
                with tf.variable_scope('conv5_2'):
                    with tf.variable_scope('conv5_2_1'):
                        ...
                        self.parameters += [weight5_2_1, biases5_2_1, offset5_2_1, scale5_2_1]
                    with tf.variable_scope('conv5_2_2'):
                        ...
                        conv5_2_2_ReLu = conv(conv5_2_1_ReLu, weight5_2_2, biases5_2_2, offset5_2_2, scale5_2_2,
                                              strides=1)
                        self.parameters += [weight5_2_2, biases5_2_2, offset5_2_2, scale5_2_2]
                    with tf.variable_scope('conv5_2_3'):
                        ...
                        self.parameters += [weight5_2_3, biases5_2_3, offset5_2_3, scale5_2_3]
                with tf.variable_scope('conv5_3'):
                    with tf.variable_scope('conv5_3_1'):
                        ...
                        self.parameters += [weight5_3_1, biases5_3_1, offset5_3_1, scale5_3_1]
                    with tf.variable_scope('conv5_3_2'):
                        ...
                        conv5_3_2_ReLu = conv(conv5_3_1_ReLu, weight5_3_2, biases5_3_2, offset5_3_2, scale5_3_2,
                                              strides=1)
                        self.parameters += [weight5_3_2, biases5_3_2, offset5_3_2, scale5_3_2]
                    with tf.variable_scope('conv2_3_3'):
                        ...
                        self.parameters += [weight5_3_3, biases5_3_3, offset5_3_3, scale5_3_3]
            ...
            with tf.variable_scope('fc'):
                ...
                fc = tf.nn.bias_add(tf.matmul(ave_pool, weight_fc2), biases_fc2)
                # fc = tf.clip_by_value(fc, -1, 1)   # 把值固定到一个范围[-1, 1]，防止数据太大爆掉
                self.parameters += [weight_fc2, biases_fc2]
        self.reuse = True
        return fc
